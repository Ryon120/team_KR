...
class Model
{
    ...
    public function create($data)
    {
        ...
        $stmt = $this->db_manager->dbh->prepare('INSERT INTO ' . $this->table . ' (title, description, `created at`, imgPath) VALUES (?, ?, ?, ?)');
        $stmt->execute($data);
    }
    ...
    public function getAll()
    {
        ...
        // dbhのメソッド
        // PDOインスタンスのメソッド
        $stmt = $this->db_manager->dbh->prepare('SELECT * FROM ' . $this->table . ' ORDER BY `created at` DESC');
